    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 justify-between">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @auth
                        ...
                        @if(auth()->user()->role === 'parent')
                            <a href="{{ route('parent.children') }}" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                                My Children
                            </a>
                        @endif
                    @endauth
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm font-semibold text-gray-900 dark:text-white">Log in</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">Register</a>
                    @endif
                @endauth
            </div>
        </div>
